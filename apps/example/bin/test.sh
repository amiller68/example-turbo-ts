...
infisical_env=$(map_to_infisical_env "$STAGE")

echo "Running image-renderer tests in $STAGE environment (Infisical: $infisical_env)..."
...
ENVIRONMENT="$STAGE" infisical run --env="$infisical_env" -- bash -c '
